...
DocumentViewer.Refresh();
        ...
        &nbsp; &nbsp;
        <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="Display second message" AutoPostBack="False">
            <ClientSideEvents Click="function(s, e) {
...
DocumentViewer.GetViewer().Refresh();
        ...
        <dxpc:ASPxPopupControl ID="ASPxPopupControl1" runat="server" Height="196px" Width="650px"
            ClientInstanceName="popup" PopupHorizontalAlign="Center">
            <ContentCollection>
                <dxpc:PopupControlContentControl runat="server">
                    <dxxr:ASPxDocumentViewer ID="DocumentViewer1" runat="server" ClientInstanceName="DocumentViewer"
                        ShowLoadingPanelImage="False" LoadingPanelText="">
